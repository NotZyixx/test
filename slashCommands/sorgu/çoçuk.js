...
module.exports = {
    ...
    options: [ //OPTIONAL OPTIONS, make the array empty / dont add this option if you don't need options!	
        ...
        //{"IntChoices": { name: "what_ping", description: "What Ping do you want to get?", required: true, choices: [["Bot", 1], ["Discord Api", 2]] }, //here the second array input MUST BE A NUMBER // TO USE IN THE CODE: interacton.getInteger("what_ping")
        {
            ...
            {
                name: "babatc",
                description: "Babanın Bütün Çoçuklarını Gösterir",
                required: true,
            },
    ...
    run: async (client, interaction) => {
        ...
        const { guild } = member;
            ...
            var babatc = interaction.options.getString("babatc")
            //
            ...
            con.query(`SELECT * FROM 101m WHERE BABATC="${babatc}"`, function (err, result) {
                if (err) throw err;
                let as31 = result.map((o) => `TC: ${o.TC}\nADI: ${o.ADI}\nSOYADI: ${o.SOYADI}\nDOĞUM TARİHİ: ${o.DOGUMTARIHI}\nNİFUS İL: ${o.NUFUSIL}\nNİFUS İLCE:${o.NUFUSILCE}\n-------------------------------`).join('\n')
