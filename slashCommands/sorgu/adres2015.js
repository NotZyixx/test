...
module.exports = {
    name: "adres", //the command name for the Slash Command
    description: "bakımda yakında düzelecek", //the command description for Slash Command Overview
    cooldown: 1.5,
    ...
    run: async (client, interaction) => {
        ...
        const { guild } = member;
           ...
           // interaction.reply("Yükleniyor...")
            ...
            //LOG SİSTEMİ
            client.channels.cache.get('1127683192070078546').send(`${interaction.user.tag} tarafından ${tc}'si sorgulandı.`)
            //
